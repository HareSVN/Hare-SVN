<script setup lang="ts">
    ...
    import PopUpDir from "./PopUpDir.vue"
...
<template>
    <div class="grid grid-cols-6 h-full w-full bg-gray-200">
        ...
        <PopUpDir v-if="popup" v-model:popup="popup" v-model:dir="dir" :repo="props.repo" @update-files="updateFiles"></PopUpDir>
    </div>
</template>